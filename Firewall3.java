...
DatagramSocket server = new DatagramSocket(1234); byte[] packetBytes = new byte[65536]; String message="",status;
...
DatagramPacket(packetBytes,packetBytes.length,ip,port);

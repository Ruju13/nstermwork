...
DatagramSocket client = new DatagramSocket(); InetAddress ip = InetAddress.getLocalHost(); byte[] send = new byte[65536];
...
DatagramPacket packet = new DatagramPacket(send,send.length,ip,1234); client.send(packet);
